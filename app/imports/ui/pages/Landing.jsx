      ...
      <div className="digits-landing-background">
        <Grid container centered stackable columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h3' inverted>This address book allows any number of user to register and save their business contacts. You can only see the contacts you have created.</Header>
          </Grid.Column>

          <Grid.Column textAlign='center'>
            <Icon size="huge" name="file alternate" inverted />
            <Header as='h1' inverted>Contacts Details</Header>
