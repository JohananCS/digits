...
import { AutoForm, HiddenField, LongTextField, TextField } from 'uniforms-semantic';
...
class EditContact extends React.Component {
  ...
  submit(data) {
    ...
    Contacts.collection.update(_id, { $set: { firstName, lastName, address, description } }, (error) => (error ?
